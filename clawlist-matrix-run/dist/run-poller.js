...
async function main() {
    ...
    const poller = new MatrixPoller(config.homeserver, config.marketRoomId, config.buyers, config.stateFile, config.pollIntervalMs || 30000);
...
main();
//# sourceMappingURL=run-poller.js.map